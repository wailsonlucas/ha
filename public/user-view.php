...
if(isset($_GET['uid'])) {
    $uid = $_GET['uid'];
    $uid = intval($uid);
    $select = $db->GetRows("SELECT * FROM `users` WHERE id = ?", [$uid]);
    $user = $select[0];
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $inv_exist = $db->GetRows("SELECT * FROM invitations WHERE sender_id = ? AND recipient_id = ?", [$sender_email, $receiver]);

    if($inv_exist){
        $select = $db->DELETE("DELETE FROM `invitations` WHERE sender_id = ? AND recipient_id = ?", [$sender_email, $receiver]);
        $addFriendState = "Request is sent...";
    } else {
        $select = $db->Insert("INSERT INTO `invitations` (sender_id, recipient_id, status) VALUES (?, ?, ?)", [$sender_email, $receiver ,'pending']);
        $addFriendState = "Add Friend";
    }
...
?>
    ...
    <head>
        ...
        <link href="assets/css/user-view.css" rel="stylesheet">
    ...
    <body class="profile">
        ...
        <div class="stripe-dialog" id="stripe-dialog">
            <div class="img-container">
                <img src="assets/images/stripwp.jpeg" alt="stripe wallpaper"/>
            </div>
            <div class="content">
            ...
            <div class="row newsfeed-size">
                <div class="col-md-12 p-0">
                    ...
                    <div class="row profile-right-side-content">
                                    ...
                                    <div class="profile-info-left">
                                        <div class="text-center">
                                            <div class="profile-img-wrapper">
                                                ...
                                                <img src="images/<?= $user['profile'] ?>" alt="Avatar" class="avatar-img">
                        ...
                        <form id="add-friend-form" method="post" action="">
                            <button id="add-friend-button" ><?php echo $addFriendState; ?></button>
                        </form>
                                        </div>
                                        ...
                                        <div class="intro mt-5 mv-hidden">
                                            ...
                                            <div class="intro-item d-flex justify-content-between align-items-center">
                                                <p class="intro-title text-muted"><i class='bx bx-time text-primary'></i> Last Login <a >Online <span class="ml-1 online-status bg-success"></span></a></p>
                                            </div>
    ...
    <script src="assets/js/app.js"></script>
    <script src="assets/js/components/components.js"></script>
    <script src="handle-stripe.js"></script>
    </body>
