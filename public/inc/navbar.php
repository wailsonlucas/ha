...
<nav id="navbar-main" class="navbar navbar-expand-lg shadow-sm sticky-top">
                    <div class="w-100 justify-content-md-center">
                        ...
                        <ul class="navbar-nav mr-5 flex-row" id="main_menu">
                            <a class="navbar-brand nav-item mr-lg-5" href="home.php">Social Media </a>
                            ...
                            <li class="nav-item s-nav">
                                <a href="profile.php" class="nav-link nav-links">
                                    <div class="menu-user-image">
                                        ...
                                        <img src="images/<?= $row['profile']?>" alt="Avatar" class="menu-user-img ml-1">
                                    </div>
                                </a>
                            </li>
                            <li class="nav-item s-nav">
                                    ...
                                    <a class="dropdown-item logout-btn" href="logout.php">
                                        <img class="p" src="assets/images/icons/navbar/logout.png" alt="Navbar icon"> Log Out</a>
        ...
        function fetchInvitations() {
            fetch('/poll_invitations.php', {method: "GET"})
                .then(response => response.json())
                .catch(error => console.error('Error while fetching invitations:', error));
        }

        // Fetch invitations immediately and then every 5 seconds
        
        fetchInvitations();
        setInterval(fetchInvitations, 5000);
    </script>
